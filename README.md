...
![Vanduo](https://img.shields.io/badge/Vanduo-vd3-0f766e?style=flat)
...
- **Custom Script Editor**: Write fighter AI in JavaScript with VdCodeEditor (@vanduo-oss/vd3-cbun)
...
Open `http://localhost:5173/` in your browser (`pnpm preview` serves the production build at `http://localhost:4173/scriptman-fighters/`).
...
├── src/
│   ├── main.ts                # App bootstrap + VanduoVue plugin
│   ├── App.vue                # Root shell
│   ├── components/            # UI (header, arena, dashboard, modals, editor)
│   ├── composables/           # Game loop, settings, disclaimer, workers
│   ├── services/              # Engine, input, script sandbox, persistence
│   ├── templates/             # Default fighter scripts A/B
│   ├── utils/                 # Canvas helpers, validation
│   ├── styles/main.css        # App chrome on vd3 tokens
│   └── types.ts
└── public/                    # Favicon, Phosphor duotone icons
```
...
- **@vanduo-oss/vd3** - UI components and theme system
- **@vanduo-oss/vd3-cbun** - Code editor (`VdCodeEditor`)
- **TypeScript** - Type-safe JavaScript
- **Canvas 2D API** - Game rendering
- **Web Workers** - Sandboxed script execution
- **Zod** - Data validation
- **Acorn** - Loop-safety AST analysis
...
- [Vanduo vd3](https://www.npmjs.com/package/@vanduo-oss/vd3)
